...
export default function TransportPage() {
  return (
    <main className="pt-20 bg-white text-gray-800">
      {/* Hero Section */}
      <section className="relative w-full h-[300px] sm:h-[500px] md:h-[70vh]">
        <Image
          src="/transport1.jpg"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
          ...
          <p className="text-white text-sm sm:text-base md:text-lg mt-3 max-w-lg drop-shadow-lg">
            Reliable, comfortable and safe transport solutions for all our guests.
          </p>
        </div>
      </section>
      ...
      <section className="bg-yellow-500 text-black py-12 text-center px-4">
        ...
        <p className="mb-6 text-lg">
          Book your transport service in advance and travel stress-free.
        </p>
        <a
...
const transportOptions = [
  {
    ...
    description:
      "Punctual and professional airport transfers to ensure your arrival and departure are smooth.",
    image: "/transport1.jpeg",
  },
  {
    title: "City Shuttle Service",
    description:
      "Explore Mbooni town and nearby attractions with our scheduled shuttle rides.",
    image: "/transport2.jpeg",
  },
  {
    title: "Private Chauffeur",
    description:
      "Enjoy personalized transport with our courteous private drivers for any occasion.",
    image: "/transport3.jpeg",
  },
  {
    title: "Tour Packages",
    description:
      "Discover scenic spots and local culture with our organized day trips and tour services.",
    image: "/transport4.jpeg",
  },
  {
    title: "Group Transport",
    description:
      "Spacious vehicles available for weddings, events, conferences and group excursions.",
